          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-2 custom-scrollbar">
              ...
              {loading ? (
                ...
                aeropuertos
                  .filter(a => !searchAero || a.codigo.toLowerCase().includes(searchAero.toLowerCase()) || a.ciudad.toLowerCase().includes(searchAero.toLowerCase()))
                  .map(a => (
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-2 custom-scrollbar">
              ...
              {loading ? (
                ...
                vuelos
                  .filter(v => !searchVuelo || v.origenCodigo.toLowerCase().includes(searchVuelo.toLowerCase()) || v.destinoCodigo.toLowerCase().includes(searchVuelo.toLowerCase()))
                  .map(v => (
