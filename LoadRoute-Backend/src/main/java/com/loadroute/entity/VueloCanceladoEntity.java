...
@Entity
@Table(name = "vuelos_cancelados", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"vuelo_id", "fecha"})
})
public class VueloCanceladoEntity {
    ...
    public VueloCanceladoEntity() {}

    public VueloCanceladoEntity(VueloEntity vuelo, LocalDate fecha) {
        this.vuelo = vuelo;
        this.fecha = fecha;
    }
