...
public class RutaResponseDTO {
    ...
    @JsonProperty("loteInicio")
    private String loteInicio;
    ...
    public String getLoteInicio() { return loteInicio; }
    public void setLoteInicio(String loteInicio) { this.loteInicio = loteInicio; }
